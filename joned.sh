...
echo -s " TOLLS $green " |lolcat

echo -s "Created By Me : ./Tuan Star$green " |lolcat

echo -s "From : S.A.D Cyber Team  $green " |lolcat

echo -a "NOTE : Aing Tamvan :v " | lolcat

echo -s "_____________________________________________________________"
